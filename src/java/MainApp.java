...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        String pass1="02072001";
        String pass3="14052001";
        String pass4="t042001";
        String pass5="anbanlientuc";
        String bcryptHashString1 = BCrypt.withDefaults().hashToString(12, password.toCharArray());
        String bcryptHashString2 = BCrypt.withDefaults().hashToString(12, pass1.toCharArray());
