                        ...
                        <div class="row">
                            <div class="col-md-2 d-flex align-items-center" style="padding: 0px">
                                <div class="position-relative snipimage"> 
                                    <a href="detail?id=${test.id}"><img src="${pageContext.request.contextPath}/img/quiz2.jpg" class="rounded img-fluid w-100 img-responsive"></a> 
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="mt-2">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h5 class="mb-1"><a href="detail?id=${test.id}">${test.name}</a> </h5>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-md-start justify-content-between views-content mt-2">
                                        <div class="d-flex flex-row align-items-center"> 
                                            <a class="badge badge-success align-text-bottom ml-1" href="list?category=${test.category.category_value}">${test.category.category_value}</a> 
                                        </div>
                                    </div>
                                    <div class="d-flex flex-row mt-3"> 
                                        ...
                                        <div class="ms-2 d-flex flex-column">
                                            <div class="d-flex flex-row align-items-center">
                                                <h6 class="text-muted pr-2">Post by </h6><a href="list?author=${test.author.username}"><h6 style="color: #06BBCC"> ${test.author.username}</h6></a> <span class="dots"></span>
                                            </div> 
                                        </div>
                                    </div>
                                </div>
